...
//		System.out.println(getPathPrim());
	...
	public void refillCities() {
		...
		cities[9] = new City("Popayï¿½n", 244, 426);
		cities[10] = new City("Valledupar", 391, 95);
		cities[11] = new City("Quibdï¿½", 245, 293);
		cities[12] = new City("Monterï¿½a", 285, 167);
		cities[13] = new City("Bogotï¿½", 357, 337);
		cities[14] = new City("Puerto Inï¿½rida", 617, 378);
		cities[15] = new City("San Josï¿½ del Guaviare", 418, 426);
		...
		cities[21] = new City("Cï¿½cuta", 425, 199);
		...
		cities[27] = new City("Ibaguï¿½", 312, 358);
		cities[28] = new City("Cali", 254, 381);
		cities[29] = new City("Mitï¿½", 523, 482);
		cities[30] = new City("Puerto Carreï¿½o", 628, 277);
	...
	public void refillCitiesK() {
		...
		citiesK[8] = new City("Popayï¿½n", 244, 426);
		citiesK[9] = new City("Valledupar", 391, 95);
		citiesK[10] = new City("Quibdï¿½", 245, 293);
		citiesK[11] = new City("Monterï¿½a", 285, 167);
		citiesK[12] = new City("Bogotï¿½", 357, 337);
		citiesK[13] = new City("San Josï¿½ del Guaviare", 418, 426);
		...
		citiesK[19] = new City("Cï¿½cuta", 425, 199);
		...
		citiesK[25] = new City("Ibaguï¿½", 312, 358);
		citiesK[26] = new City("Cali", 254, 381);
		citiesK[27] = new City("Puerto Carreï¿½o", 628, 277);
